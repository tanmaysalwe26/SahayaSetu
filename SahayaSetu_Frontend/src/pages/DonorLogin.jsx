...
export default function DonorLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      // Simulate successful login with user's actual email as name
      const userData = {
        type: 'donor',
        email: email,
    ...
    <div className="d-flex align-items-center justify-content-center vh-100 bg-light" style={{ paddingTop: '80px' }}>
      ...
      >
        <div className="card-body p-4 text-center">
          ...
          <h3 className="fw-bold text-success">Donor Login</h3>
          <p className="text-muted mb-4">
            Login to support NGOs and track your donations.
          </p>
